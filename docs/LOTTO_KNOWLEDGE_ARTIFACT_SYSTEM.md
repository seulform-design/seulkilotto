...
| ID | 상태 | 생성 방향 |
|----|------|-----------|
| `01_knowledge` | partial | 출처·export 0.1.0 · draw-machine 교차링크 후속 |
| `03_draw_machine` | partial | SOURCES 0.1.0 · 제조사 PDF·물리는 Experimental |
...
| `09_validation` | active | propose_retirements · 승인 disable API 후속 |
| `10_explain` | partial | V1–V4·복기 Explain 공용 UI 완료 |
